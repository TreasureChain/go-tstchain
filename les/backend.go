...
import (
	...
	"github.com/TreasureChain/go-tstchain/light"
	...
	rpc "github.com/TreasureChain/go-tstchain/rpc"
)
...
func New(ctx *node.ServiceContext, config *eth.Config) (*LightTstchain, error) {
...
func (s *LightDummyAPI) Tstbase() (common.Address, error) {
...
// APIs returns the collection of RPC services the tstchain package offers.
