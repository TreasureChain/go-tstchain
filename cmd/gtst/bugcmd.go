...
import (
	...
	"github.com/TreasureChain/go-tstchain/cmd/internal/browser"
...
const issueURL = "https://github.com/TreasureChain/go-tstchain/issues/new"

// reportBug reports a bug by opening a new URL to the go-tstchain GH issue
