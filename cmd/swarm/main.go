...
import (
	...
	"github.com/TreasureChain/go-tstchain/console"
	"github.com/TreasureChain/go-tstchain/crypto"
	"github.com/TreasureChain/go-tstchain/internal/debug"
	...
	"github.com/TreasureChain/go-tstchain/swarm"
	bzzapi "github.com/TreasureChain/go-tstchain/swarm/api"
	swarmmetrics "github.com/TreasureChain/go-tstchain/swarm/metrics"
	"github.com/TreasureChain/go-tstchain/swarm/tracing"
...
func init() {
	...
	app.Copyright = "Copyright 2013-2016 The go-tstchain Authors"
...
Export a local chunk database as a tar archive (use - to send to stdout).
    ...
    swarm db export ~/.tstchain/swarm/bzz-KEY/chunks chunks.tar

The export may be quite large, consider piping the output through the Unix
pv(1) tool to get a progress bar:

    swarm db export ~/.tstchain/swarm/bzz-KEY/chunks - | pv > chunks.tar
`,
				},
				{
					Action:             dbImport,
...
Import chunks from a tar archive into a local chunk database (use - to read from stdin).
    ...
    swarm db import ~/.tstchain/swarm/bzz-KEY/chunks chunks.tar

The import may be quite large, consider piping the input through the Unix
pv(1) tool to get a progress bar:

    pv chunks.tar | swarm db import ~/.tstchain/swarm/bzz-KEY/chunks -
`,
				},
				{
					Action:             dbClean,
...
func bzzd(ctx *cli.Context) error {
	...
	//register BZZ as node.Service in the tstchain node
...
func registerBzzService(bzzconfig *bzzapi.Config, stack *node.Node) {
	...
	//register within the tstchain node
