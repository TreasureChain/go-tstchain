...
import (
	...
	"github.com/TreasureChain/go-tstchain/signer/core"
	"github.com/TreasureChain/go-tstchain/signer/rules"
	"github.com/TreasureChain/go-tstchain/signer/storage"
...
func init() {
	app.Name = "Clef"
	app.Usage = "Manage Tstchain account operations"
	app.Flags = []cli.Flag{
		logLevelFlag,
		keystoreFlag,
		configdirFlag,
