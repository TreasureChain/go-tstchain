...
// StateDBs within the tstchain protocol are used to store anything
...
//
// Carrying over the balance ensures that Tst doesn't disappear.
...
func (self *StateDB) Copy() *StateDB {
	...
	for addr := range self.journal.dirties {
		// As documented [here](https://github.com/TreasureChain/go-tstchain/pull/16485#issuecomment-380438527),
